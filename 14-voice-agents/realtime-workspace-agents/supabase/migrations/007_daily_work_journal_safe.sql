...
DROP INDEX IF EXISTS idx_daily_work_journal_user_date;
DROP INDEX IF EXISTS idx_daily_work_journal_user_timestamp;
DROP INDEX IF EXISTS idx_daily_work_journal_project;
...
DROP POLICY IF EXISTS "Users can view their own journal entries" ON daily_work_journal;
DROP POLICY IF EXISTS "Users can insert their own journal entries" ON daily_work_journal;
DROP POLICY IF EXISTS "Users can update their own journal entries" ON daily_work_journal;
DROP POLICY IF EXISTS "Users can delete their own journal entries" ON daily_work_journal;
...
DROP TRIGGER IF EXISTS trigger_update_daily_work_journal_updated_at ON daily_work_journal;
DROP FUNCTION IF EXISTS update_daily_work_journal_updated_at();
